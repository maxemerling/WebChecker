...
public class LinkCheckerPool {

    private static final int CORE_THREAD_COUNT = 500, MAX_THREAD_COUNT = 1000;
    ...
    public static void main(String[] args) {
        LinkCheckerPool linkChecker = new LinkCheckerPool();
